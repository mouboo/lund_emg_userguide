...
\begin{center}
	\begin{tikzpicture}
	\node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=0.8\textwidth]{./img/9}};
	\begin{scope}[x={(image.south east)},y={(image.north west)}]
...
\begin{center}
	\begin{tikzpicture}
	\node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=0.8\textwidth]{./img/10}};
	\begin{scope}[x={(image.south east)},y={(image.north west)}]
...
\begin{center}
	\begin{tikzpicture}
	\node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=0.8\textwidth]{./img/11}};
	\begin{scope}[x={(image.south east)},y={(image.north west)}]
...
\begin{center}
	\begin{tikzpicture}
	\node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=0.8\textwidth]{./img/12}};
	\begin{scope}[x={(image.south east)},y={(image.north west)}]
